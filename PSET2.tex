...
\begin{subsol}
    ...
    \end{align*}
    If $l - \hat{l} \leq 0$, we can see that we are left with an original optimization problem as seen before, as $\mu = 0$. However, there remains the case where $\hat{l} > l$
\end{subsol}
