...
\begin{subprob}
    ...
    \[
    r_{90} = \frac{0.0-123m+ 0.0079 + 0.05}{3(0.073)} - 0.05 = 0.2689
    \]
    \[
    r_{10} = \frac{0.0068 + 0.0044 + 0.04}{3(0.073)} - 0.05 = 0.183
    \]
    we can see that the model successfully explains the decline in the real interest. However, the model does overestimate the interest rate for both time frames. 
\end{subprob}
