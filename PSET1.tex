...
\]
which is directly proprotinal to that of the function with no scaled inputs. Therefore, this function returns to scale mathematically. 
\subsection*{e}
If we double our inputs into a firm, they will produce exactly double the amount. 
\end{document}