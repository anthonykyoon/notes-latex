...
\begin{itemize}
    \item If $p < \frac{1}{\alpha}$, we can see that our profit will be less than 0 as our marginal cost must be less than that of 
\end{itemize}
Hence, we can see what our supply functions are 
\section{}
\subsection*{a}
