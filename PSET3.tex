...
\section{}
\subsection*{a}
If $x_2$ is to be fixed at 1, we see that $x_1 \in (0,1]$ as if $x_1 = 0$, no production would occur and thus no profit would be made. So let us consider the profit function for a firm, say firm 1. We can see that 
\section{}
